...
\begin{cventries}
  ...
  {
    \begin{cvitems}
      \item {Architected an AI-native legal platform spanning mobile app, web workspace, browser extension, core backend, and dedicated knowledge services.}
      \item {Designed the platform around Node.js/NestJS, MongoDB, Redis, Qdrant, OpenAI, OCR, and streaming/voice workflows for document analysis, legal search, and conversational experiences.}
      \item {Built a self-hosted, security-first platform with observability, CI/CD, secret management, and encrypted handling of sensitive legal data.}
    \end{cvitems}
  }
  ...
  {
    \begin{cvitems}
      \item {Line managing the QA team in the ecosystem test area, including priorities, delivery, and team growth.}
      \item {Owning QA strategy, test architecture, QA minima, test scenarios, and quality metrics across the product and ecosystem.}
      \item {Driving the quality of E2E coverage across frontend, backend, and cross-system workflows.}
      \item {Testing Django-based backend services and integrations, while supporting ecosystem-wide security, performance, and reliability initiatives.}
